...
1. Einem Kornbild-Modul, dass eine Klasse zur Abbildung der Kornbilder und je ein Interface zur Vorverarbeitung und Auswertung bietet
2. Einem Vorverarbeitungs-Modul, dass leicht erweiterbar die Vorverarbeitungen in einem möglichst einheitlichen Interface definiert
3. Einem Analyse-Modul, dass auch leicht erweiterbar wieder mit einem einheitlichen Interface Analysemethoden definiert
4. Einem GUI-Modul, dass die Darstellung der Kornbilder, der Korngrößen und die Interaktion mit dem Kornbild ermöglicht
