...
Beim Normalized Cuts Verfahren zur Extraktion von Superpixeln [@shiNormalizedCutsImage2000] wird das Bild in einen Graphen übersetzt, bei dem jeder Pixel durch einen Knoten repräsentiert wird. Jeder dieser Knoten wird dann mit jedem anderen Knoten über einen Kante verbunden, die über ein Maß gewichtet wird, das die Wahrscheinlichkeit der 